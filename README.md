...
**Title : File Scrapping For Emails.**<br/>
you can visit the site at https://taskstreamlit.herokuapp.com/ <br/>
this is a python web program using streamlit.<br/>
Steps To Follow<br/>
Step 1: Select main project from the drop down .<br/>
Step 2: Click on Browse files .<br/>
Step 3: Select file which is to be used for Scrapping.(a sample csv file is attached to the project).<br/>
This project basically is a sorting app. which sort the email from large files which is provided by user and the 
app will display the content on screen first it displays the email and then the file content.<br/>
some screenshot attached:<br/>
